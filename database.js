        ...
        if (answers.build === 'View all employees') {        
          ...
          return inquirer.prompt([
            ...
            db.query(
              ...
              [answers.role_name_new, answers.salary_new, deptId],
              function(err, results) {
                updateObjAndArrays();
                startPage();
              }            
          ...
          return inquirer.prompt([
           ...
           db.query(
            ...
            [answers.first_name, answers.last_name, roleVar, empMan],
          ...
          return inquirer.prompt([
            ...
            [answers.first_name, answers.last_name, roleVar, empMan, empId],
            function(err, results) {
              updateObjAndArrays();
              startPage();
            }
